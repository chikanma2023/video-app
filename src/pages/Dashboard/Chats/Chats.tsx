...
const Chats = () => {
  ...
  return (
    <div className="h-[100%] rounded-lg">
      ...
      <div
        className={`mt-7 shadow-lg flex h-[120vh] overflow-hidden w-full ${
      ...
      >
        ...
        <div
          className={`relative w-1/3 max-sm:w-full  ${
            theme === "light" ? "bg-[#FFF9FA]" : "bg-[#111111]"
          } overflow-auto
     scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent scroll-smooth md:!block ${
       !selectMessage ? "block" : "hidden"
     }`}
        >
          <div
            className={`p-8 sticky top-0 ${
              theme === "light" ? "bg-[#FFF9FA]" : "bg-[#111111]"
            }`}
          >
          ...
          <div className="px-8">
            {Array(10)
              ...
              .map((each, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-3 mb-6 p-2 cursor-pointer ${
                    selectedIndex === index ? "bg-gray-100 rounded-md" : ""
                  }`}
                  onClick={() => {
                    setSelectedIndex(index), setSelectMessage(true);
                  }}
                >
                  <img
                    src={profileImage}
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-gray-500 text-[0.7rem] font-light">
                        10:35 AM
                      </span>
                    </div>
        ...
        <div
          className={`p-8 max-sm:p-2 w-2/3 relative flex flex-col max-sm:w-full md:!flex ${
            selectMessage ? "flex" : "hidden"
          }`}
        >
          {/* CONVERSATION BOX */}
          <FaTimes
            className="absolute top-5 right-5 w-5 h-5 cursor-pointer md:hidden max-sm:visible"
            onClick={() => setSelectMessage(false)}
          />
     ...
     scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent scroll-smooth"
          ...
          <div
            className={` ${
              theme === "light" ? "bg-gray-100" : "bg-[#2C2C2C]"
            } px-3 py-5`}
          >
            <div className="flex items-center">
              <div className="flex items-center w-full bg-white p-2 rounded-3xl">
                ...
                <input
                  className="outline-none w-full py-2 border-r"
                  type="text"
